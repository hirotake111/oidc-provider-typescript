...
type OIDCProviderModel = "Session";
/**
 * Adapter example
 */
abstract class Adapter {
   ...
   *
   */
  abstract upsert(id: string, payload: string, expiresIn: number): Promise<any>;
  /**
   *
   ...
   *
   */
  abstract findByUserCode(userCode: string): Promise<any>;
   ...
   *
   */
  abstract findByUid(uid: string): Promise<any>;
   ...
   *
   */
  abstract consume(id: string): Promise<any>;
   ...
   *
   */
  abstract revokeByGrantId(grantId: string): Promise<any>;
}

export { Adapter, OIDCProviderModel };
